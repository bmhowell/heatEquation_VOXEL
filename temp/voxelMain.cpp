...
void lastTemp2file(std::vector< std::vector<double> >& cubeCoord,
    ...
    // write to file
    printDensity.open("/Users/bhopro/Desktop/Berkeley/MSOL/Projects/Voxel/temp/lastTemp.dat");
...
void density2file(std::vector< std::vector<double> > &cubeCoord,
    ...
    // write to file
    printDensity.open("/Users/bhopro/Desktop/Berkeley/MSOL/Projects/Voxel/temp/density.dat");
